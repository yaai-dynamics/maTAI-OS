 ...
 *
 * A maTAI partner is a verified business registered on the platform; its
  ...
  return (
    <Card>
      <CardHeader
        ...
        subtitle="Partners are verified businesses on maTAI. Places found online are not partners, and have no price here."
      />
                ...
                <Row key={stay.night} icon={<BedDouble size={16} />}>
                  ...
                  {partner ? (
                    ...
                    <p className="mt-0.5 text-[13px] text-ink-700">
                      No maTAI partner stay near {placeName(stay.destinationId)} yet.
                    </p>
                  )}
        ...
        <section aria-labelledby={`transport-${trip.id}`} className="space-y-3 border-t border-line pt-4">
          ...
          <Row icon={<Car size={16} />}>
            {transportPartner && transport ? (
              ...
              <p className="text-[13px] text-ink-700">No maTAI partner with vehicles yet: hire locally.</p>
            )}
