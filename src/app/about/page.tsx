...
/**
 * About mTour Agent: the whole product on one page — the three interfaces, the
 * closed loop and the provenance rules. The tourist home at /explore is the
 * front door; this is the page to present from.
 */

export const metadata: Metadata = {
  title: { absolute: 'About mTour Agent' },
  description:
    'mTour Agent connects the Tourism Department, creators and tourists through a shared tourism intelligence layer.',
};
